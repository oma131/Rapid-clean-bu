...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://rapidclean-laundry.onrender.com/api/auth/register', {
        fullname,
        email,
        userpassword,
        // confirmPassword,
  ...
  //     const backendResponse = await axios.post('https://rapidclean-laundry.onrender.com/api/auth/register', { token }); // Send token to backend
